...
export const tariffConfigs = sqliteTable('tariff_configs', {
  ...
  oaCssRatePaisa: integer('oa_css_rate_paisa'),
  oaAdditionalSurchargePaisa: integer('oa_additional_surcharge_paisa'),
  oaTransmissionLossBps: integer('oa_transmission_loss_bps'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
});
...
export const bills = sqliteTable('bills', {
  ...
  ppaEnergyChargesPaisa: integer('ppa_energy_charges_paisa').notNull().default(0),
  crossSubsidySurchargePaisa: integer('cross_subsidy_surcharge_paisa').notNull().default(0),
  additionalSurchargePaisa: integer('additional_surcharge_paisa').notNull().default(0),
  transmissionLossChargesPaisa: integer('transmission_loss_charges_paisa').notNull().default(0),
